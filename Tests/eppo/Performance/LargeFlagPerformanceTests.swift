...
//        print("🎯 Focus: Fast startup comparison with correctness validation")
//
...
//
//            print("   🧹 Protobuf test completed, releasing memory...")
//            return results
...
//        print("📊 Protobuf: \(Int(protobufResults.startupTime))ms startup, \(Int(protobufResults.evaluationsPerSecond)) evals/sec")
//        print("\n🏁 SPEEDUP:")
//        print("   ⚡ Startup: \(String(format: "%.1f", startupSpeedup))x faster with Protobuf")
...
//
//        print("\n✅ JSON vs Protobuf Lazy performance benchmark completed!")
//    }
//
//    func testJSONPerformanceBenchmark() throws {
//        // JSON vs Protobuf Lazy performance comparison as requested
//        print("🚀 Starting JSON vs Protobuf Lazy Performance Benchmark")
//        print("🎯 Focus: Fast startup comparison with correct evaluation logic")
//
//        // Load JSON data
//        let jsonData = try loadTestDataFile("flags-10000.json")
//        print("   📄 JSON: \(ByteCountFormatter.string(fromByteCount: Int64(jsonData.count), countStyle: .binary))")
...
//
//        print("\n🏆 PERFORMANCE RESULTS:")
//        print("📊 JSON: \(Int(jsonStartupTime))ms startup, \(Int(evaluationsPerSecondJSON)) evals/sec")
//        print("📊 Protobuf Lazy: \(Int(protobufStartupTime))ms startup, \(Int(evaluationsPerSecondProtobuf)) evals/sec")
//        print("\n🏁 SPEEDUP:")
//        print("   ⚡ Startup: \(String(format: "%.1f", startupSpeedup))x faster with Protobuf")
//        print("   🚀 Evaluation: \(String(format: "%.1f", evaluationsPerSecondProtobuf/evaluationsPerSecondJSON))x protobuf vs json")
//
//        // Cleanup
//        jsonClient = nil
//        protobufClient = nil
...
//        print("   ⚡ JSON startup: \(Int(startupTime))ms, Memory: +\(String(format: "%.1f", memoryDiff))MB")
//
...
//        let memoryAfter = self.getCurrentMemoryUsage()
//        let memoryDiff = memoryAfter - memoryBefore
//        print("   ⚡ Protobuf startup: \(Int(startupTime))ms, Memory: +\(String(format: "%.1f", memoryDiff))MB")
//
...
//        let evaluationsPerSecond = Double(totalEvaluations) / (evaluationTime / 1000.0)
//
//        print("   ✅ Protobuf evals: \(totalEvaluations) in \(Int(evaluationTime))ms")
//
//        // AGGRESSIVE CLEANUP
//        client = nil
//
