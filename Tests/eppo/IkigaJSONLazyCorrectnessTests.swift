...
/**
 * IkigaJSONLazyCorrectnessTests verifies that IkigaJSON Lazy and standard JSON modes produce identical assignment results.
 * This test loads the same flag configuration in both formats and compares assignment values.
 * The lazy approach uses IkigaJSON for fast startup with on-demand Swift object conversion.
 */
final class IkigaJSONLazyCorrectnessTests: XCTestCase {
    var jsonClient: EppoClient!
    var ikigaJSONLazyClient: IkigaJSONLazyClient!
    ...
    override func setUpWithError() throws {
        ...
        // Create IkigaJSON Lazy client using the same JSON data
        ikigaJSONLazyClient = try IkigaJSONLazyClient(
            sdkKey: "ikiga-json-lazy-test-key",
            jsonData: jsonData,
            obfuscated: false,
            assignmentLogger: nil
        )
    ...
    override func tearDownWithError() throws {
        jsonClient = nil
        ikigaJSONLazyClient = nil
        try super.tearDownWithError()
    }

    func testIkigaJSONLazyCorrectnessAgainstJSON() throws {
        // Get all test case files (same as EppoClientUFCTests)
        let testFiles = try getTestFiles()
        var totalComparisons = 0
        var successfulComparisons = 0

        print("🧪 Starting IkigaJSON Lazy vs JSON correctness comparison")
        ...
        for testFile in testFiles {
            ...
            for subject in testCase.subjects {
                ...
                case "BOOLEAN":
                    ...
                    let ikigaJSONLazyResult = ikigaJSONLazyClient.getBooleanAssignment(
                        flagKey: testCase.flag,
                        subjectKey: subject.subjectKey,
                        subjectAttributes: subjectAttributes,
                        defaultValue: defaultValue
                    )
                    assignmentsMatch = (jsonResult == ikigaJSONLazyResult)
                    if !assignmentsMatch {
                        print("   ❌ MISMATCH: Boolean flag \(testCase.flag) for subject \(subject.subjectKey)")
                        print("      JSON: \(jsonResult), IkigaJSON Lazy: \(ikigaJSONLazyResult)")
                    }
                ...
                case "NUMERIC":
                    ...
                    let ikigaJSONLazyResult = ikigaJSONLazyClient.getNumericAssignment(
                        flagKey: testCase.flag,
                        subjectKey: subject.subjectKey,
                        subjectAttributes: subjectAttributes,
                        defaultValue: defaultValue
                ...
                case "INTEGER":
                    ...
                    let ikigaJSONLazyResult = ikigaJSONLazyClient.getIntegerAssignment(
                        flagKey: testCase.flag,
                        subjectKey: subject.subjectKey,
                        subjectAttributes: subjectAttributes,
                        defaultValue: defaultValue
                ...
                case "STRING":
                    ...
                    let ikigaJSONLazyResult = ikigaJSONLazyClient.getStringAssignment(
                        flagKey: testCase.flag,
                        subjectKey: subject.subjectKey,
                        subjectAttributes: subjectAttributes,
                        defaultValue: defaultValue
                ...
                case "JSON":
                    ...
                    let ikigaJSONLazyResult = ikigaJSONLazyClient.getJSONStringAssignment(
                        flagKey: testCase.flag,
                        subjectKey: subject.subjectKey,
                        subjectAttributes: subjectAttributes,
                        defaultValue: defaultValue
        ...
        print("✅ IkigaJSON Lazy vs JSON correctness test completed:")
        ...
        XCTAssertEqual(successfulComparisons, totalComparisons,
                      "IkigaJSON Lazy and JSON modes should produce identical assignment results")
    }
